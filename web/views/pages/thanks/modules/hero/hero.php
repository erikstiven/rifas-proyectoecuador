...
<div class="container-fluid p-0" id="heroCheckout">
    ...
    <div class="position-relative">
        ...
        <svg class="position-absolute" style="bottom:5px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
            <path fill="#5A0B5C" fill-opacity="1" d="M0,288L60,282.7C120,277,240,267,360,245.3C480,224,600,192,720,176C840,160,960,160,1080,176C1200,192,1320,224,1380,240L1440,256L1440,320L1380,320C1320,320,1200,320,1080,320C960,320,840,320,720,320C600,320,480,320,360,320C240,320,120,320,60,320L0,320Z"></path>
        </svg>
