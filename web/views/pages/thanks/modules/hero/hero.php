            ...
            <div class="row row-cols-1 pt-4">
                ...
                <div class="offset-3 col-6 textAlign text-dark text-center">
                    ...
                    <?php else: ?>
                         ...
                         <h1 class="josefin-sans-700 text-uppercase py-2 px-1 b1 pt-3 mb-0 mb-lg-3 rounded">Estamos procesando y validando tu pago</h1>
                    ...
                    <div class="text-center position-relative" style="z-index:1">
                        ...
                        <div class="d-flex flex-wrap w-100 justify-content-center p-2 rounded">
                            ...
                            <?php foreach (explode(",",$order->numbers_order) as $key => $value): ?>
